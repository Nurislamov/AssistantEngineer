...
public class BuildingHeatingReportDataServiceTests
{
    ...
    private static BuildingHeatingReportDataService CreateService(
        Building building)
    {
        var loadCalculations = new HeatingLoadCalculationsFacadeStub(
            building);
    ...
    private sealed class HeatingLoadCalculationsFacadeStub : ILoadCalculationsFacade
    {
        private readonly BuildingHeatingLoadService _buildingHeatingLoadService;

        public HeatingLoadCalculationsFacadeStub(
            Building building)
        {
            _buildingHeatingLoadService = new BuildingHeatingLoadService(
        ...
        public Task<Result<BuildingHeatingLoadResult>> CalculateBuildingHeatingLoadAsync(
            ...
            CancellationToken cancellationToken) =>
            _buildingHeatingLoadService.CalculateAsync(
                buildingId,
                method.ToDomain(),
                cancellationToken);
    ...
    private sealed class BuildingHeatingReadModelRepositoryStub : IBuildingHeatingReadModelRepository
    {
        ...
        public BuildingHeatingReadModelRepositoryStub(
            Building building)
        {
