...
public class AggregateCalculationServiceTests
{
    [Fact]
    ...
    private static AggregateCalculationService CreateService(AppDbContext context)
    {
        return new AggregateCalculationService(context, new RoomCalculationService());
    }
