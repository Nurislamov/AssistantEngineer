...
public class BuildingReportServiceTests
{
    [Fact]
    ...
    private static BuildingReportService CreateService(AppDbContext context)
    {
        return new BuildingReportService(context, new RoomCalculationService());
    }
