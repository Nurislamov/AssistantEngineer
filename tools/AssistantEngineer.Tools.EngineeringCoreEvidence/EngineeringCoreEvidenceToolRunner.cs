...
internal static class EngineeringCoreEvidenceToolRunner
{
    ...
    public static int GenerateAllEvidence()
    {
    ...
    public static int GenerateReleaseEvidence(string outputPath)
    {
    ...
    public static int GenerateExportDisclosureChecklist(string outputPath)
    {
    ...
    public static int GenerateTraceabilityMatrix(string outputDirectory)
    {
        EnsureFile(ManifestPath, "Manifest");
        EnsureFile(DiagnosticsCatalogPath, "Diagnostics catalog");
