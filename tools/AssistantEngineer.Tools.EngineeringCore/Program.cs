...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            return command switch
            {
                ...
                "verify-calculation-module-annual-monthly-coverage" => VerifyCalculationModuleAnnualMonthlyCoverage(repoRoot),
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine("  verify-calculation-module-annual-monthly-coverage");
    ...
    private static int VerifyCalculationModuleEquipmentSizingOversizing(string repoRoot)
    {
        WriteStep("Run equipment sizing oversizing limit tests");
    ...
    private static int VerifyCalculationModuleAnnualMonthlyCoverage(string repoRoot)
    {
        WriteStep("Run annual energy monthly coverage diagnostics tests");
        return RunDotnetTest("AnnualEnergyMonthlyCoverageDiagnosticsTests");
    }
    ...
    private static int VerifyCalculationModuleDeepeningAll(string repoRoot)
    {
        var steps = new Func<string, int>[]
        {
            ...
            VerifyCalculationModuleAnnualMonthlyCoverage,
