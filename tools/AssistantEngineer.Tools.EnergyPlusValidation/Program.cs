...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        try
        {
            ...
            {
                "compare-fixtures" => CompareFixtures(HasSwitch(toolArgs, "require-real-references")),
                "assert-smoke001-real-fixture-ready" => AssertSmoke001RealFixtureReady(HasSwitch(toolArgs, "require-real-fixture")),
                "generate-fixture-catalog" => GenerateFixtureCatalog(),
                "generate-comparison-summary" => GenerateComparisonSummary(),
                "generate-validation-readiness" => GenerateValidationReadiness(),
                "generate-smoke001-comparison-readiness" => GenerateSmoke001ComparisonReadiness(),
                "generate-validation-evidence" => GenerateValidationEvidence(),
                "regenerate-validation-artifacts" => RegenerateValidationArtifacts(),
    ...
    private static int RegenerateValidationArtifacts()
    {
    ...
    private static int VerifyValidation()
    {
    ...
    private static int CompareFixtures(bool requireRealReferences)
    {
    ...
    private static int AssertSmoke001RealFixtureReady(bool requireRealFixture)
    {
    ...
    private static int GenerateSmoke001ComparisonReadiness()
    {
    ...
    private static int GenerateFixtureCatalog()
    {
    ...
    private static int GenerateComparisonSummary()
    {
        var registry = ReadObject(RegistryPath);
    ...
    private static int GenerateValidationReadiness()
    {
        var registry = ReadObject(RegistryPath);
    ...
    private static int GenerateValidationEvidence()
    {
        var registry = ReadObject(RegistryPath);
