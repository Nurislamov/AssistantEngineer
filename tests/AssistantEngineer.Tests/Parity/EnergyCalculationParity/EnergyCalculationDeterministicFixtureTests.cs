...
public class EnergyCalculationDeterministicFixtureTests
{
        ...
        string fileName)
    {
        ...
        Assert.Equal("Energy Calculation Parity / Transmission Heat Transfer", fixture.Method);
        ...
        string fileName)
    {
        ...
        Assert.Equal("InternalDeterministic", fixture.ReferenceType);
        Assert.Equal("Energy Calculation Parity / Window Solar Gains", fixture.Method);
        ...
        string fileName)
    {
        ...
        Assert.Equal("InternalDeterministic", fixture.ReferenceType);
        Assert.Equal("Energy Calculation Parity / Ventilation and Infiltration Loads", fixture.Method);
    ...
    {
        var fixture = EnergyCalculationParityFixtureLoader.Load("single-zone-no-solar.json");
    ...
    {
        var fixture = EnergyCalculationParityFixtureLoader.Load("single-zone-solar-south-window.json");
    ...
    {
        var fixture = EnergyCalculationParityFixtureLoader.Load("single-zone-annual-8760.json");
