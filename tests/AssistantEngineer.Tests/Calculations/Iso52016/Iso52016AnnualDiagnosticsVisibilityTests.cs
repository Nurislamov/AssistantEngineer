...
public class Iso52016AnnualDiagnosticsVisibilityTests
{
    [Fact]
    public async Task CalculateBuildingEnergyNeedsAsync_ExposesWeatherSolarContextDiagnosticsWhenContextIsAvailable()
    {
        ...
        var calculator = new Iso52016HourlySteadyStateCalculator(
            ...
            weatherSolarContextBuilder: new DiagnosticWeatherSolarContextBuilder());
        ...
        Assert.Contains(result.Diagnostics!, diagnostic =>
            diagnostic.Code == "Iso52016.PerezAnisotropicModelVisibleInAnnualResult");
        Assert.Contains(result.Diagnostics!, diagnostic =>
                    ...
                    Hours: hours)
                {
                    ...
                    [
                        new CalculationDiagnostic(
                            ...
                            "Synthetic annual visibility test exposes Perez model diagnostics.",
                            "test")
                    ]
                });
        }
