...
public class Iso52016V2SolverStageTraceabilityTests
{
    [Fact]
    public void Manifest_ClosesExpectedStageWorkItems()
    {
        ...
        var manifestPath = Path.Combine(
            ...
            "docs",
            "releases",
            "Iso52016V2SolverStageManifest.json");
    ...
    public void TraceabilityMatrix_MapsEveryClosedWorkItemToImplementationGuards()
    {
        ...
        var matrixPath = Path.Combine(
            ...
            "docs",
            "traceability",
            "Iso52016V2SolverTraceabilityMatrix.json");
        ...
        Assert.Contains(items, item =>
            ...
            item.GetProperty("implementationGuards").EnumerateArray().Any(guard =>
                guard.GetString() == "Iso52016V2HourlySolver"));
    ...
    [Fact]
    public void SourceTree_StillContainsV2SolverIntegrationAndApiGuards()
    {
        var repoRoot = FindRepositoryRoot();
        ...
        Assert.Contains("Iso52016V2HourlySolver", sourceText);
