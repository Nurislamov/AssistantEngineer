...
public class Iso52016V2ReducedRoomModelBuilderTests
{
    private readonly Iso52016V2ReducedRoomModelBuilder _builder = new();
    ...
    public void Build_RejectsInvalidTimeStep()
    {
        ...
        Assert.Equal("ISO 52016 V2 reduced room model time step must be greater than zero.", result.Error);
    }
