...
public class CalculationsDependencyInjectionTests
{
    ...
    public void AddCalculationsModuleRegistersCalculationServices()
    {
        ...
        AssertServiceLifetime<ICalculationTraceBuilder>(services, ServiceLifetime.Transient);
        AssertServiceLifetime<ICalculationTraceSanitizer>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ICalculationTraceJsonExporter>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ICalculationTraceDiagnosticMapper>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ICalculationTraceModuleAdapter>(services, ServiceLifetime.Singleton);
        ...
        AssertServiceLifetime<IGroundTemperatureProfileCalculator>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<IGroundTemperatureProfileProvider>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<IGroundBoundaryHeatTransferCalculator>(services, ServiceLifetime.Singleton);
        ...
        AssertServiceLifetime<IDomesticHotWaterDrawOffProfileBuilder>(services, ServiceLifetime.Singleton);
        ...
        AssertServiceLifetime<IDomesticHotWaterLossCalculator>(services, ServiceLifetime.Singleton);
        ...
        AssertServiceLifetime<ISystemEnergyDistributionCalculator>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ISystemEnergyStorageCalculator>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ISystemEnergyGenerationCalculator>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ISystemEnergyLoadIntakeBuilder>(services, ServiceLifetime.Singleton);
        AssertServiceLifetime<ISystemEnergyFoundationCalculator>(services, ServiceLifetime.Singleton);
