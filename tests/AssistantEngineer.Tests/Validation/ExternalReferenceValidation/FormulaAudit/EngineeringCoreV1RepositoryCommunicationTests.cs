...
public class EngineeringCoreV1RepositoryCommunicationTests
{
    ...
    public void RootReadmeKeepsForbiddenReleaseWordingVisibleAsForbidden()
    {
        ...
        Assert.Contains("EnergyPlus comparison workflow achieved", content, StringComparison.Ordinal);
        Assert.Contains("ASHRAE 140 / BESTEST-style validated", content, StringComparison.Ordinal);
