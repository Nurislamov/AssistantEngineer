...
public sealed class GreeGmvMiniRouting12_1Tests
{
    ...
    [InlineData("Gree GMV Mini P0", "Gree GMV Mini P0", "Gree GMV P0")]
    [InlineData("Gree Mini P0", "Gree GMV Mini P0", "Gree GMV P0")]
    [InlineData("Gree GMV Mini 01", "Gree GMV Mini 01", "Gree GMV o1")]
    [InlineData("Gree Mini 01", "Gree GMV Mini 01", "Gree GMV o1")]
    ...
    public async Task UnqualifiedN2StillAsksForGmv6OrGmvMini()
    {
        ...
        Assert.Contains("Уточните серию", response.Text, StringComparison.OrdinalIgnoreCase);
    }
