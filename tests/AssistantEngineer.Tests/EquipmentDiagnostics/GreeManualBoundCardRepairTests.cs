...
public sealed class GreeManualBoundCardRepairTests
{
    ...
    private static readonly Dictionary<string, (string Code, string Meaning)> Gmv6IndoorTableOnlyD11aBatch =
        new(StringComparer.Ordinal)
        {
            ...
            ["lh.json"] = ("LH", "предупреждение о низком качестве воздуха"),
            ["lj.json"] = ("LJ", "ошибка настройки кода функционального DIP-переключателя"),
            ["ll.json"] = ("LL", "неисправность реле протока воды"),
            ["lp.json"] = ("LP", "неисправность перехода через ноль двигателя PG"),
            ["lu.json"] = ("LU", "неисправность перехода через ноль двигателя PG"),
            ["o0.json"] = ("o0", "другая неисправность привода"),
            ["o1.json"] = ("o1", "низкое напряжение шины внутреннего блока"),
            ["o2.json"] = ("o2", "высокое напряжение шины внутреннего блока"),
            ["o3.json"] = ("o3", "защита IPM-модуля внутреннего блока"),
            ["o4.json"] = ("o4", "внутренний блок не запускается"),
            ["o5.json"] = ("o5", "защита внутреннего блока по сверхтоку"),
            ["o6.json"] = ("o6", "неисправность цепи контроля тока внутреннего блока"),
            ["o7.json"] = ("o7", "защита внутреннего блока от рассинхронизации"),
            ["o8.json"] = ("o8", "нарушение связи привода внутреннего блока"),
            ["o9.json"] = ("o9", "нарушение связи главного устройства внутреннего блока"),
            ["oa.json"] = ("oA", "высокая температура модуля внутреннего блока"),
            ["ob.json"] = ("ob", "неисправность датчика температуры модуля внутреннего блока"),
            ["oc.json"] = ("oC", "неисправность цепи зарядки внутреннего блока"),
            ["y1.json"] = ("y1", "неисправность датчика температуры входной трубки 2"),
            ["y2.json"] = ("y2", "неисправность датчика температуры выходной трубки 2"),
            ["y7.json"] = ("y7", "неисправность датчика температуры приточного воздуха"),
            ["y8.json"] = ("y8", "неисправность датчика воздушной камеры внутреннего блока"),
