...
public sealed class ErrorKnowledgeJsonValidationTests
{
    ...
    public void GreeVisibleTextsDoNotExposeManualReferenceMarkers()
    {
        ...
        Assert.Equal(1293, files.Length);
    ...
    public void RepositoryKnowledgeDirectoryLoadsSuccessfully()
    {
        ...
        Assert.All(
            entries.Where(entry =>
                ...
                !entry.Id.StartsWith("gree-umatch-r32-", StringComparison.OrdinalIgnoreCase) &&
                !entry.Id.StartsWith("gree-erv-b-series-", StringComparison.OrdinalIgnoreCase)),
    ...
    public void GreeGmvProtectionPackageManifestLoadsSuccessfully()
    {
        ...
        Assert.True(result.IsValid);
        Assert.Equal(21, result.Packages.Count);
    ...
    private static void VerifyPublishedKnowledgeAssembly(string modulePath)
    {
        ...
        try
        {
            ...
            Assert.Equal(1293, entries.Length);
