...
- ISO52016 room-envelope compatibility behavior remains default. ISO52016-inspired construction/mass envelope input integration is available as controlled opt-in (`Iso52016ConstructionOptions.UseConstructionLayerMassInput`) with compatibility fallback behavior; this is not a full ISO 52016 compliance or external parity claim.
