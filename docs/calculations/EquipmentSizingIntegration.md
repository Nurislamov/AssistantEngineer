...
This Standard-Based Calculation step links calculated loads to HVAC equipment sizing.
...
Room equipment selection uses the Standard-Based Calculation load and sizing path:
