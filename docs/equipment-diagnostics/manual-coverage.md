...
- Imported manuals: 1.
- New, not imported: 30.
- Needs identity or duplicate review: 16.
...
| `gree-gmv-idu-service-manual` | `SERVICE_MANUAL_GMV_IDU.pdf` | New | NotAnalyzed | Next recommended import; verify exact series/models first |
