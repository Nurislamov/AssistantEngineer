...
Use only after ED-22A release evidence, ED-22B release-candidate review, ED-22C deployment dry-run evidence, ED-22D activation-checklist evidence, ED-22E final go/no-go evidence, and ED-22F release tag/handoff review pass. Stop when a prerequisite, safety boundary, or access-policy review is incomplete.
