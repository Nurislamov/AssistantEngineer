...
3. Run the ED-22C deployment activation dry-run, ED-22D activation checklist, and ED-22E final go/no-go evidence, then review the activation runbook and final handoff before deterministic bot scenario smoke tests.
