...
3. Run the ED-22C deployment activation dry-run and ED-22D activation checklist, then review the activation runbook before deterministic bot scenario smoke tests.
