...
After merge into `master`, follow the [ED-22F release tag and handoff procedure](../equipment-diagnostics/telegram-closed-beta-release-tag-and-handoff.md) and complete the placeholder-only [release notes template](../equipment-diagnostics/telegram-closed-beta-release-notes-template.md). Tag creation and push remain manual.
