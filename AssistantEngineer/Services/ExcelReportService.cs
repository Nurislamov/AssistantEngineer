...
{
    public byte[] GenerateBuildingReport(BuildingReportDto report)
    {
    ...
    private static void AddSummaryWorksheet(XLWorkbook workbook, BuildingReportDto report)
    {
    ...
    private static void AddRoomsWorksheet(
        XLWorkbook workbook,
        IReadOnlyCollection<BuildingRoomReportRowDto> rooms)
    {
    ...
    private static void AddWindowsWorksheet(
        XLWorkbook workbook,
        IReadOnlyCollection<WindowReportRowDto> windows)
    {
    ...
    private static void AddWallsWorksheet(
        XLWorkbook workbook,
        IReadOnlyCollection<WallReportRowDto> walls)
    {
