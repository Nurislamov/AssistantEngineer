...
namespace AssistantEngineer.Domain.Services.Calculations;

public class RoomCalculationService
{
    public const double DefaultDesignReserveFactor = 1.10;
        ...
        IEnumerable<Wall> walls)
    {
        ...
        const double designReserveFactor = DefaultDesignReserveFactor;
        ...
        var designCapacityW = totalHeatLoadW * designReserveFactor;
        ...
        return new RoomCalculationResult
        {
            ...
            DesignReserveFactor = designReserveFactor,
