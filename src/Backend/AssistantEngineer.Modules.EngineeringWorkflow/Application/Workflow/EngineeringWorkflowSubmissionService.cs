...
public sealed class EngineeringWorkflowSubmissionService : IEngineeringWorkflowSubmissionService
{
    ...
    private readonly IEngineeringWorkflowScenarioRunner _scenarioRunner;
    private readonly IEngineeringWorkflowJobService _jobService;
    ...
    public EngineeringWorkflowSubmissionService(
        IEngineeringWorkflowScenarioRunner scenarioRunner,
        IEngineeringWorkflowJobService jobService,
