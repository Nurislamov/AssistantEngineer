    ...
    public static string ImprovePhrase(string value) =>
        value
            ...
            .Replace(
                ...
                "Сопоставить код, модель и фактические симптомы с указанным разделом руководства. Если подробная процедура не добавлена в справочник, выполнять диагностику по указанному разделу руководства.",
                StringComparison.Ordinal)
            .Replace(
                "категорию «Наладка»",
