...
internal static class CoolingLoadResultFactory
{
    public static RoomCalculationResult Create(
        ...
        double windowGain,
        double wallGain,
        double ventilationGain,
        double infiltrationGain,
        double naturalVentilationGain,
        double peopleGain,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new RoomCalculationResult
        {
            ...
            PeakHourOfYear = hourlyHeatLoadW.Count == 8760 ? peakHour : null,
            ...
            VentilationHeatGainW = Round(ventilationGain),
            InfiltrationHeatGainW = Round(infiltrationGain),
            NaturalVentilationHeatGainW = Round(naturalVentilationGain),
            ...
            CoolingLoadW = Round(totalLoad),
            CoolingLoadKw = Round(totalLoad / 1000.0),
