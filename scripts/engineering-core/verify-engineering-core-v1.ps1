...
Invoke-Step "Engineering Core test profile script guard tests" {
    dotnet test .\AssistantEngineer.sln --filter "EngineeringCoreV1TestProfileScriptsTests"
}

Invoke-Step "Engineering Core release readiness gate tests" {
