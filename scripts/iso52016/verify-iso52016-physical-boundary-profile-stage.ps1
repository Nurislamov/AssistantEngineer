...
Invoke-StageVerifier -RelativePath 'scripts\iso52016\verify-iso52016-physical-surface-model-stage.ps1'
...
Assert-NoPositiveParityClaims -Scope 'ISO52016 physical boundary profile stage' -RelativePaths @(
    'docs\calculations\Iso52016PhysicalBoundaryProfileStage.md',
    'docs\releases\Iso52016PhysicalBoundaryProfileStageManifest.json'
)

Invoke-StageTests -Filter 'FullyQualifiedName~Iso52016PhysicalSurfaceBoundaryCondition|FullyQualifiedName~Iso52016PhysicalBoundaryProfileStageTraceability'
