...
if ($envExample.IndexOf("TELEGRAM_IS_ENABLED=false", [StringComparison]::Ordinal) -lt 0 -or
    ...
    $envExample.IndexOf("TELEGRAM_OPERATOR_INBOX_ENABLED=false", [StringComparison]::Ordinal) -lt 0 -or
    $envExample.IndexOf("TELEGRAM_OPERATOR_CHAT_ID=", [StringComparison]::Ordinal) -lt 0 -or
    $envExample.IndexOf("TELEGRAM_OPERATOR_LOG_DIAGNOSTICS=false", [StringComparison]::Ordinal) -lt 0 -or
