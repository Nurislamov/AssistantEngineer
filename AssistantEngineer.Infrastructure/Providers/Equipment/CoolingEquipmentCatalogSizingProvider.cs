...
namespace AssistantEngineer.Infrastructure.Providers.Equipment;
...
public sealed class CoolingEquipmentCatalogSizingProvider : ICoolingEquipmentCatalogSizingProvider
{
    ...
    public CoolingEquipmentCatalogSizingProvider(
    ...
    {
        var items = await _catalog.ListActiveByTypeAsync(
            systemType,
            unitType,
            cancellationToken);
